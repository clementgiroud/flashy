...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<?= base_url('assets/stylesheets/fullcalendar/dist/fullcalendar.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('assets/stylesheets/fullcalendar/dist/fullcalendar.print.min.css')?>" media="print">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('assets/stylesheets/AdminLTE.min.css')?>">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?= base_url('assets/stylesheets/_all-skins.min.css')?>">
...
<!-- jQuery UI 1.11.4 -->
<script src="<?= base_url('assets/jquery/jquery-ui/jquery-ui.min.js')?>"></script>
<!-- Slimscroll -->
<script src="<?= base_url('assets/jquery/jquery-slimscroll/jquery.slimscroll.min.js')?>"></script>
<!-- FastClick -->
<script src="<?= base_url('assets/javascripts/fastclick/lib/fastclick.js')?>"></script>
<!-- AdminLTE App -->
<script src="<?= base_url('assets/javascripts/adminlte.min.js')?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?= base_url('assets/javascripts/demo.js')?>"></script>
<!-- fullCalendar -->
