...
<div id="container">
	...
	<div id="body">
		<?php if($images->num_rows() > 0) : ?>
			...
			<div align="center"><?=anchor('gallery/add','Ajouter une image',['class'=>'btn btn-primary'])?></div>
			<hr />
			<div class="row">
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p>
								<?=anchor('gallery/edit/'.$img->id,'Mettre à jour',['class'=>'btn btn-warning', 'role'=>'button'])?>
								<?=anchor('gallery/delete/'.$img->id,'Supprimer',['class'=>'btn btn-danger', 'role'=>'button','onclick'=>'return confirm(\'Are you sure?\')'])?>
							</p>
						</div>
					</div>
				</div>
